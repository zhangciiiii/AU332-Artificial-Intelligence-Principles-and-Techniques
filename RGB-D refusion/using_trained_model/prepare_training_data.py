...
def main():
    ...
    for one_scene in tqdm(folder_list):
        ...
        for rgb_image, depth_image in tqdm(zip(rgb_images, depth_images)):
            ...
            rgb_image = resize_image_rgb(args.dataset_dir+'/'+one_scene+'/rgb/'+rgb_image) # numpy array
            depth_image = resize_image_depth(args.dataset_dir+'/'+one_scene+'/depth/'+depth_image)
