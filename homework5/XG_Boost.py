...
# LogisticRegression
def testXGBoost(features, labels, features_test):

    XG_model = XGBClassifier(subsample=0.8, n_estimators=100, random_state=45, learning_rate=0.31)
...
if __name__ == '__main__':
    ...
    testXGBoost(features, labels, features_test)
'''
